...
const menuGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "FPGA Architecture", href: "/fpga-architecture", icon: Grid3X3,     description: "LUT packing, timing closure, DSP/BRAM, congestion" },
      { label: "PDN Analysis",     href: "/pdn-analysis",     icon: Zap,          description: "Target impedance, IR drop, decap tiers, rail noise" },
      { label: "Silicon Photonics",href: "/silicon-photonics",icon: Waves,        description: "Waveguides, ring resonators, MZM, optical link" },
      { label: "ML Accelerator",   href: "/ml-accelerator",   icon: Cpu,          description: "Systolic arrays, roofline, transformer FLOPs, quantization" },
